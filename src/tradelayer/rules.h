#ifndef BITCOIN_TRADELAYER_RULES_H
#define BITCOIN_TRADELAYER_RULES_H
...
//! Feature identifier to enable non-Trade Layer pairs on the distributed exchange
...
public:
    ...
    //! Block to enable trading of non-Trade Layer pairs
    int TRADEALLPAIRS_FEATURE_BLOCK;
    //! Block to enable the fee system & 0.05% fee for trading non-Trade Layer pairs
...
#endif // BITCOIN_TRADELAYER_RULES_H
