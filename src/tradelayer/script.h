#ifndef BITCOIN_TRADELAYER_SCRIPT_H
#define BITCOIN_TRADELAYER_SCRIPT_H
...
int64_t TLGetDustThreshold(const CScript& scriptPubKey);
...
#endif // BITCOIN_TRADELAYER_SCRIPT_H
