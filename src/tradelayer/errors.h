#ifndef BITCOIN_TRADELAYER_ERRORS_H
#define BITCOIN_TRADELAYER_ERRORS_H
...
enum MPRPCErrorCode
{
    ...
    MP_TX_IS_NOT_TL_PROTOCOL    = -3336,  // No Trade Layer Protocol transaction.
...
inline std::string error_str(int ec) {
  ...
  switch (ec)
  {
      ...
      case MP_INPUT_NOT_IN_RANGE:
          ec_str = "Input value supplied larger than supported in Trade Layer Protocol";
          break;
...
#endif // BITCOIN_TRADELAYER_ERRORS_H
