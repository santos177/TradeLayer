#ifndef BITCOIN_TRADELAYER_DBTXLIST_H
#define BITCOIN_TRADELAYER_DBTXLIST_H
...
public:
    ...
    int GetTLTxsInBlockRange(int blockFirst, int blockLast, std::set<uint256>& retTxs);
...
#endif // BITCOIN_TRADELAYER_DBTXLIST_H
