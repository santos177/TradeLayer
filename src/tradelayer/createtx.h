#ifndef BITCOIN_TRADELAYER_CREATETX_H
#define BITCOIN_TRADELAYER_CREATETX_H
...
/**
 * Builder to create Trade Layer transactions.
 *
...
public:
     ...
     */
    TLTxBuilder& addMultisig(const std::vector<unsigned char>& data, const std::string& seed, const CPubKey& pubKey);
...
#endif // BITCOIN_TRADELAYER_CREATETX_H
