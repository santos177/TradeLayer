#ifndef BITCOIN_TRADELAYER_DBFEES_H
#define BITCOIN_TRADELAYER_DBFEES_H
 ...
 */
class CTLFeeCache : public CDBBase
{
public:
    CTLFeeCache(const fs::path& path, bool fWipe);
    virtual ~CTLFeeCache();
 ...
 */
class CTLFeeHistory : public CDBBase
{
public:
    CTLFeeHistory(const fs::path& path, bool fWipe);
    virtual ~CTLFeeHistory();
...
{
    //! LevelDB based storage for the MetaDEx fee cache
    extern CTLFeeCache* pDbFeeCache;
    //! LevelDB based storage for the MetaDEx fee distributions
    extern CTLFeeHistory* pDbFeeHistory;
}

#endif // BITCOIN_TRADELAYER_DBFEES_H
