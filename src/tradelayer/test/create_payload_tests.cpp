...
BOOST_AUTO_TEST_CASE(payload_tradelayer_alert_block)
{
    // Omni Core client notification [type 65535, version 65535]
    std::vector<unsigned char> vch = CreatePayload_TradeLayerAlert(
...
BOOST_AUTO_TEST_CASE(payload_tradelayer_alert_blockexpiry)
{
    // Omni Core client notification [type 65535, version 65535]
    std::vector<unsigned char> vch = CreatePayload_TradeLayerAlert(
...
BOOST_AUTO_TEST_CASE(payload_tradelayer_alert_minclient)
{
    // Omni Core client notification [type 65535, version 65535]
    std::vector<unsigned char> vch = CreatePayload_TradeLayerAlert(
