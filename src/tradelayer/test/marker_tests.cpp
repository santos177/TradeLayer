#include <tradelayer/test/utils_tx.h>
...
BOOST_FIXTURE_TEST_SUITE(tradelayer_marker_tests, BasicTestingSetup)
...
{
    {
        ...
        CTransaction tx(mutableTx);
        BOOST_CHECK_EQUAL(GetEncodingClass(tx, nBlock), TL_CLASS_A);
    }
    {
...
{
    {
        ...
        CTransaction tx(mutableTx);
        BOOST_CHECK_EQUAL(GetEncodingClass(tx, nBlock), TL_CLASS_B);
    }
    {
...
{
    {
        ...
        CTransaction tx(mutableTx);
        BOOST_CHECK_EQUAL(GetEncodingClass(tx, nBlock), TL_CLASS_C);
    }
    {
        int nBlock = std::numeric_limits<int>::max();
