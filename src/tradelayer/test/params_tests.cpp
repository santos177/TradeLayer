...
BOOST_FIXTURE_TEST_SUITE(tradelayer_params_tests, BasicTestingSetup)
...
BOOST_AUTO_TEST_CASE(ecosystem_restrictions_main)
{
    ...
    BOOST_CHECK(!IsTransactionTypeAllowed(0, TL_PROPERTY_MSC, MSC_TYPE_OFFER_ACCEPT_A_BET, MP_TX_PKT_V0));
    BOOST_CHECK(IsTransactionTypeAllowed(0, TL_PROPERTY_TMSC, MSC_TYPE_OFFER_ACCEPT_A_BET, MP_TX_PKT_V0));
}
...
BOOST_AUTO_TEST_CASE(update_feature_network)
{
    ...
    BOOST_CHECK(!IsTransactionTypeAllowed(newActivationBlock, TL_PROPERTY_MSC, MSC_TYPE_OFFER_ACCEPT_A_BET, MP_TX_PKT_V0));
