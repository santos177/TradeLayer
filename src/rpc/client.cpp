...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "tl_getcrowdsale", 0, "propertyid" },
    { "tl_getcrowdsale", 1, "verbose" },
    ...
    { "tl_sendissuancecrowdsale", 1, "ecosystem" },
    { "tl_sendissuancecrowdsale", 2, "type" },
    { "tl_sendissuancecrowdsale", 3, "previousid" },
    { "tl_sendissuancecrowdsale", 9, "propertyiddesired" },
    { "tl_sendissuancecrowdsale", 11, "deadline" },
    { "tl_sendissuancecrowdsale", 12, "earlybonus" },
    { "tl_sendissuancecrowdsale", 13, "issuerpercentage" },
    { "tl_senddexaccept", 2, "propertyid" },
    { "tl_senddexaccept", 4, "override" },
    { "tl_sendclosecrowdsale", 1, "propertyid" },
   ...
   { "tl_createrawtx_change", 4, "arg4" },
    ...
    { "tl_createpayload_issuancecrowdsale", 0, "ecosystem" },
    { "tl_createpayload_issuancecrowdsale", 1, "type" },
    { "tl_createpayload_issuancecrowdsale", 2, "previousid" },
    { "tl_createpayload_issuancecrowdsale", 8, "propertyiddesired" },
    { "tl_createpayload_issuancecrowdsale", 10, "deadline" },
    { "tl_createpayload_issuancecrowdsale", 11, "earlybonus" },
    { "tl_createpayload_issuancecrowdsale", 12, "issuerpercentage" },
    { "tl_createpayload_closecrowdsale", 0, "propertyid" },
